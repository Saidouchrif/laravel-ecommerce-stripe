        ...
        <div class="bg-white rounded-lg shadow-md p-6 max-w-2xl mx-auto">
            ...
            <form action="{{ route('admin.categories.update', $category->id_categorie) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="name_categorie" id="name_categorie"
                        value="{{ old('name_categorie', $category->name_categorie) }}" required
                ...
                <div class="flex items-center justify-between">
                    ...
                    <button type="submit" class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700">Mettre à
                        jour la catégorie</button>
                </div>
            </form>
        </div>
    </div>
