...
<style>
    @media (max-width: 767px) {
        ...
        .auth-form .auth-password-row label {
            text-align: start;
        }

        .auth-form .auth-password-row a {
...
<section class="auth-page bg-zinc-50 flex items-center justify-center min-h-[calc(100vh-64px)] py-12 px-4 sm:px-6 md:px-0">
    <div class="auth-card max-w-md w-full bg-white p-8 rounded-3xl shadow-xl">
        ...
        <form action="{{ route('login') }}" method="POST" class="auth-form space-y-6">
            @csrf
            <div>
            ...
            <div>
                <div class="auth-password-row flex items-center justify-between mb-2">
            ...
            <div class="auth-remember flex items-center">
